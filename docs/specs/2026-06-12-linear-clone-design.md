...
Cohere is a B2B multi-tenant Linear clone: organizations (workspaces) contain teams; teams contain issues with Linear-grade workflow features, realtime collaboration, and a plan-gated AI agent.
